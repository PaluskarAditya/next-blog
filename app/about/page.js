...
export default function page() {
  return (
    <div className='flex-col flex justify-center items-center p-6'>
      <h1 className='text-4xl font-bold'>Exploring the Intersection of Tech and Creativity: Aditya Paluskar's Tech Blog</h1>
      <p className='text-sm py-10'>Welcome to my Tech Blog, where I delve into the exciting world of technology and creativity. I'm Aditya Paluskar, a tech enthusiast, developer, and a firm believer in the power of innovation. In this blog, I'll be sharing insights, tips, and tutorials on various tech topics. Feel free to connect with me on Instagram, GitHub, and LinkedIn for more tech updates and discussions.</p>
      <h1 className='pt-10'>Perks of exploring this blog :</h1>
      <div className='py-5'>
        <h3 className='text-sm font-bold'>The Art of Coding and Creativity</h3>
        <p className='text-sm'>In today's tech-driven world, coding is not just about functionality but also about creativity. I'll discuss how coding can be an art form and how developers can infuse creativity into their projects.</p>
      </div>
      <div className='py-5'>
